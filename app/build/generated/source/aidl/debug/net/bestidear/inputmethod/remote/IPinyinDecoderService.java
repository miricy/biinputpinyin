 ...
 * Original file: /home/alva/AndroidStudioProjects/biinputpinyin/app/src/main/aidl/net/bestidear/inputmethod/remote/IPinyinDecoderService.aidl
 */
package net.bestidear.inputmethod.remote;
public interface IPinyinDecoderService extends android.os.IInterface
{
/** Local-side IPC implementation stub class. */
public static abstract class Stub extends android.os.Binder implements net.bestidear.inputmethod.remote.IPinyinDecoderService
{
private static final java.lang.String DESCRIPTOR = "net.bestidear.inputmethod.remote.IPinyinDecoderService";
...
/**
 * Cast an IBinder object into an net.bestidear.inputmethod.remote.IPinyinDecoderService interface,
 * generating a proxy if needed.
 */
public static net.bestidear.inputmethod.remote.IPinyinDecoderService asInterface(android.os.IBinder obj)
{
if ((obj==null)) {
return null;
}
android.os.IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
if (((iin!=null)&&(iin instanceof net.bestidear.inputmethod.remote.IPinyinDecoderService))) {
return ((net.bestidear.inputmethod.remote.IPinyinDecoderService)iin);
}
return new net.bestidear.inputmethod.remote.IPinyinDecoderService.Stub.Proxy(obj);
}
...
private static class Proxy implements net.bestidear.inputmethod.remote.IPinyinDecoderService
{
