...
public class CandidateView extends View {
    ...
    private void onSizeChanged() {
        mContentWidth = getMeasuredWidth() - this.getPaddingLeft() - this.getPaddingRight();
        mContentHeight = (int) ((getMeasuredHeight() - this.getPaddingTop() - this.getPaddingBottom()) * 0.95f);
        /**
  ...
  //      mActiveCandInPage = 0;
    ...
    protected void onDraw(Canvas canvas) {
        ...
        float xPos = this.getPaddingLeft();
        ...
        for (int i = 0; i < pSize; i++) {
            ...
            if (mActiveCandInPage == i && mEnableActiveHighlight) {
                mActiveCellRect.set(xPos, this.getPaddingTop() + 1, xPos
                        + itemTotalWidth, getHeight() - this.getPaddingBottom() - 1);
    ...
    private float drawVerticalSeparator(Canvas canvas, float xPos) {
        mSeparatorDrawable.setBounds((int) xPos, this.getPaddingTop(), (int) xPos
