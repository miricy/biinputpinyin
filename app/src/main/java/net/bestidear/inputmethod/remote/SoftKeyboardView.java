...
import net.bestidear.inputmethod.remote.SoftKeyboard.KeyRow;
...
public class SoftKeyboardView extends View {
    ...
    public SoftKeyboardView(Context context, AttributeSet attrs) {
        ...
        mSoundManager = SoundManager.getInstance(this.getContext());
    ...
    public boolean setSoftKeyboard(SoftKeyboard softSkb) {
        ...
        mSoftKeyFocus=mSoftKeyboard.getKey(3,0);
    ...
    public SoftKey onKeyPress(int x, int y,
        ...
        if (null != mBalloonOnKey) {
            ...
            mHintLocationToSkbContainer[0] = this.getPaddingLeft() + mSoftKeyDown.mLeft
                    - (mBalloonOnKey.getWidth() - mSoftKeyDown.width()) / 2;
            mHintLocationToSkbContainer[0] += mOffsetToSkbContainer[0];
            mHintLocationToSkbContainer[1] = this.getPaddingTop()
        ...
        if (mSoftKeyDown.needBalloon()) {
            ...
            mHintLocationToSkbContainer[0] += mOffsetToSkbContainer[0];
            mHintLocationToSkbContainer[1] = this.getPaddingTop() + mSoftKeyDown.mTop
    ...
    public SoftKey onKeyRelease(int x, int y) {
        ...
        if (mSoftKeyDown.moveWithinKey(x - this.getPaddingLeft(), y - this.getPaddingTop())) {
            return mSoftKeyDown;
        }
        return null;
    }
